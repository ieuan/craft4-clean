<?php  //[STAMP] 45f6978910c6642ab1e06239256468d3
// phpcs:ignoreFile
...
trait AcceptanceTesterActions
{
     ...
     * @see \craft\test\Craft::resetProjectConfig()
     */
    public function tryToResetProjectConfig(bool $force = false): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('resetProjectConfig', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes resetProjectConfig and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::resetProjectConfig()
     */
    public function retryResetProjectConfig(bool $force = false) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('resetProjectConfig', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::setupDb()
     */
    public function tryToSetupDb(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('setupDb', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes setupDb and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::setupDb()
     */
    public function retrySetupDb() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('setupDb', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::installPlugin()
     */
    public function tryToInstallPlugin(array $plugin): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('installPlugin', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes installPlugin and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::installPlugin()
     */
    public function retryInstallPlugin(array $plugin) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('installPlugin', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::getCodeceptionName()
     */
    public function tryToGetCodeceptionName(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('getCodeceptionName', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes getCodeceptionName and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::getCodeceptionName()
     */
    public function retryGetCodeceptionName() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('getCodeceptionName', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::normalizePathSeparators()
     */
    public function tryToNormalizePathSeparators(mixed $path): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('normalizePathSeparators', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes normalizePathSeparators and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::normalizePathSeparators()
     */
    public function retryNormalizePathSeparators(mixed $path) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('normalizePathSeparators', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::createDbConfig()
     */
    public function tryToCreateDbConfig(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('createDbConfig', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes createDbConfig and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::createDbConfig()
     */
    public function retryCreateDbConfig() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('createDbConfig', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::expectEvent()
     */
    public function tryToExpectEvent(string $class, string $eventName, callable $callback, string $eventInstance = "", array $eventValues = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('expectEvent', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes expectEvent and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::expectEvent()
     */
    public function retryExpectEvent(string $class, string $eventName, callable $callback, string $eventInstance = "", array $eventValues = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('expectEvent', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::saveElement()
     */
    public function tryToSaveElement(\craft\base\ElementInterface $element, bool $failHard = true): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('saveElement', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes saveElement and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::saveElement()
     */
    public function retrySaveElement(\craft\base\ElementInterface $element, bool $failHard = true) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('saveElement', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::deleteElement()
     */
    public function tryToDeleteElement(\craft\base\ElementInterface $element, bool $hardDelete = true, bool $failHard = true): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('deleteElement', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes deleteElement and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::deleteElement()
     */
    public function retryDeleteElement(\craft\base\ElementInterface $element, bool $hardDelete = true, bool $failHard = true) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('deleteElement', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::assertElementsExist()
     */
    public function tryToAssertElementsExist(string $elementType, array $searchProperties = [], int $amount = 1, bool $searchAll = false): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertElementsExist', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes assertElementsExist and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::assertElementsExist()
     */
    public function retryAssertElementsExist(string $elementType, array $searchProperties = [], int $amount = 1, bool $searchAll = false) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertElementsExist', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::assertTestFails()
     */
    public function tryToAssertTestFails(callable $callable, string $message = ""): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertTestFails', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes assertTestFails and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::assertTestFails()
     */
    public function retryAssertTestFails(callable $callable, string $message = "") {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertTestFails', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::assertEqualDates()
     */
    public function tryToAssertEqualDates(\Codeception\TestInterface $test, string $dateOne, string $dateTwo, float $secondsDelta = 5.0): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertEqualDates', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes assertEqualDates and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::assertEqualDates()
     */
    public function retryAssertEqualDates(\Codeception\TestInterface $test, string $dateOne, string $dateTwo, float $secondsDelta = 5.0) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertEqualDates', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::mockMethods()
     */
    public function tryToMockMethods(\yii\base\Module $module, string $component, array $params = [], array $constructorParams = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('mockMethods', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes mockMethods and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::mockMethods()
     */
    public function retryMockMethods(\yii\base\Module $module, string $component, array $params = [], array $constructorParams = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('mockMethods', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::mockCraftMethods()
     */
    public function tryToMockCraftMethods(string $component, array $params = [], array $constructorParams = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('mockCraftMethods', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes mockCraftMethods and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::mockCraftMethods()
     */
    public function retryMockCraftMethods(string $component, array $params = [], array $constructorParams = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('mockCraftMethods', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::mockDbMethods()
     */
    public function tryToMockDbMethods(array $params = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('mockDbMethods', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes mockDbMethods and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::mockDbMethods()
     */
    public function retryMockDbMethods(array $params = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('mockDbMethods', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::runQueue()
     */
    public function tryToRunQueue(string $queueItem, array $params = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('runQueue', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes runQueue and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::runQueue()
     */
    public function retryRunQueue(string $queueItem, array $params = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('runQueue', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::assertPushedToQueue()
     */
    public function tryToAssertPushedToQueue(string $description): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertPushedToQueue', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes assertPushedToQueue and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::assertPushedToQueue()
     */
    public function retryAssertPushedToQueue(string $description) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertPushedToQueue', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::assertNotPushedToQueue()
     */
    public function tryToAssertNotPushedToQueue(string $description): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertNotPushedToQueue', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes assertNotPushedToQueue and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::assertNotPushedToQueue()
     */
    public function retryAssertNotPushedToQueue(string $description) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertNotPushedToQueue', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::getFieldLayoutByFieldHandle()
     */
    public function tryToGetFieldLayoutByFieldHandle(string $fieldHandle): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('getFieldLayoutByFieldHandle', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes getFieldLayoutByFieldHandle and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::getFieldLayoutByFieldHandle()
     */
    public function retryGetFieldLayoutByFieldHandle(string $fieldHandle) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('getFieldLayoutByFieldHandle', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \craft\test\Craft::createEventItems()
     */
    public function tryToCreateEventItems(array $config = []): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('createEventItems', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes createEventItems and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \craft\test\Craft::createEventItems()
     */
    public function retryCreateEventItems(array $config = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('createEventItems', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes grabFixtures and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Yii2::grabFixtures()
     */
    public function retryGrabFixtures() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('grabFixtures', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes grabFixture and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Yii2::grabFixture()
     */
    public function retryGrabFixture($name, $index = NULL) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('grabFixture', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes grabComponent and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Yii2::grabComponent()
     */
    public function retryGrabComponent(mixed $component) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('grabComponent', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Yii2::seeEmailIsSent()
     */
    public function tryToSeeEmailIsSent(?int $num = NULL): bool {
     ...
     * @see \Codeception\Module\Yii2::seeEmailIsSent()
     */
    public function retrySeeEmailIsSent(?int $num = NULL) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Yii2::getInternalDomains()
     */
    public function tryToGetInternalDomains(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('getInternalDomains', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes getInternalDomains and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Yii2::getInternalDomains()
     */
    public function retryGetInternalDomains() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('getInternalDomains', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Codeception\Module\Yii2::createAndSetCsrfCookie()
     */
    public function tryToCreateAndSetCsrfCookie(string $val): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('createAndSetCsrfCookie', func_get_args()));
    }
    /**
     * [!] Method is generated.
     * 
     * * Executes createAndSetCsrfCookie and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Codeception\Module\Yii2::createAndSetCsrfCookie()
     */
    public function retryCreateAndSetCsrfCookie(string $val) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('createAndSetCsrfCookie', func_get_args(), $retryNum, $retryInterval));
    }
